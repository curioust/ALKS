...
public class ARPController extends MasterController{
		...
		public ModelAndView newARP(@RequestParam(value = "error", required = false) String error){
			...
			if(accounts == null || accounts.size()<1){
				mav.addObject(MessageUtils.ERROR,MessageUtils.getMessage("com.coxautoinc.cia.alks.controller.ARPController.new.noAccount"));
			}
			if(error!=null && error.equals("true")){
				mav.addObject(MessageUtils.ERROR,MessageUtils.getMessage("com.coxautoinc.cia.alks.controller.ARPController.new.invalidPolicy"));
			}
